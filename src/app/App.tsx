                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="flex items-start gap-4 mb-8">
                        ...
                        <div>
                          ...
                          <p className="text-[#B7C6CF]">3460 Oakmeadow Lane<br/>Cincinnati, Ohio 45239</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-4">
                        <div className="w-12 h-12 bg-gradient-to-r from-[#1E3FD8] via-[#4F73D6] to-[#B7C6CF] rounded-lg flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                          ...
                          <p className="text-[#B7C6CF]">Monday - Friday: 8:00 AM - 6:00 PM EST<br/>Saturday: 9:00 AM - 3:00 PM EST<br/>Sunday: Closed</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
